        ...
        <div class="col-lg-12">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="form">
                        <form  method="post" action="{{ route('role.store') }}" class="cmxform form-horizontal tasi-form" id="signupForm">
                            @csrf
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                    <input id="fa_title" name="fa_title" type="text" value="{{old('fa_title')}}" class="form-control @error('fa_title') error @enderror" />
                                    @error('fa_title')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <select multiple="" class="form-control" name="permission_id[]" id="permission_id">
                                        ...
                                        <option value="{{ $permission->id }}">{{ $permission->fa_title . " - " . $permission->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
